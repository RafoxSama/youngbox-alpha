...
class PostsController extends AppController
{
    ...
    public function unlike()
    {
        ...
        if (is_null($like)) {
            $json['message'] = "Vous ne l'aimez ce post!";
            $json['error'] = true;
    ...
    public function like()
    {
        ...
        if (!is_null($like)) {
            $json['message'] = "Vous aimez déjà ce post!";
            $json['error'] = true;
    ...
    public function delete()
    {
        ...
        if (is_null($post)) {
            $this->Flash->error('Ce poste n\'existe pas ou a été supprimée');
        ...
        if ($post->id == $post->forum_thread->first_post_id) {
            $this->Flash->error('Vous ne pouvez pas supprimer le premier poste d\'un topic.');
        ...
        if (!$this->ForumPosts->delete($post)) {
            $this->Flash->success('Une erreur est survenue lors de la suppression du poste. Veuillez réessayer.');
        ...
        $this->Flash->success('Le poste a été supprimé avec succès!');
...
EOT;
    ...
    public function go($postId = null)
    {
        ...
        if (is_null($post)) {
            $this->Flash->error('Ce poste n\'existe pas ou a été supprimé.');
    ...
    public function edit($id = null)
    {
        ...
        if ($post->user_id != $this->Auth->user('id') && !( $currentUser->is_admin || $currentUser->is_staff || $currentUser->is_modo)) {
            $this->Flash->error('Vous ne avez pas de l\'autorisation de modifier ce post!');
        ...
        if ($this->ForumPosts->save($post)) {
            $this->Flash->success('Ce poste a été modifié avec succès!');
        }

        return $this->redirect(['action' => 'go', $post->id]);
      }else {
        $this->set(compact('currentUser', 'post', 'breadcrumbs'));
      }
    }
    ...
    public function getEditPost()
    {
        ...
        if (is_null($post)) {
            $json['error'] = true;
            $json['errorMessage'] = "Ce poste n'existe pas ou a été supprimée!";
        ...
        if ($post->user_id != $this->Auth->user('id') && !( $currentUser->is_admin || $currentUser->is_staff || $currentUser->is_modo)) {
            $json['error'] = true;
            $json['errorMessage'] = "Vous ne disposez pas de l'autorisation de modifier ce post!";
