...
class TopicsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'post_at' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'sticky' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        '_indexes' => [
            'fk_topics_forums1_idx' => ['type' => 'index', 'columns' => ['forum_id'], 'length' => []],
            'fk_topics_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created_at' => '2016-08-04 23:30:55',
            'updated_at' => '2016-08-04 23:30:55',
            'forum_id' => 1,
            'user_id' => 1,
            'post_at' => '2016-08-04 23:30:55',
            'sticky' => 1
        ],
    ];
}
